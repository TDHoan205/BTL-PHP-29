    ...
    <div class="col-xl-6">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0"><i class="fas fa-history text-secondary me-2"></i>Hoạt động gần đây</h5>
            </div>
                ...
                <ul class="activity-list">
                    <?php if(!empty($data['recentActivities'])): ?>
                        ...
                        <li class="activity-item">
                            <div class="activity-icon bg-<?= $activity['color'] ?? 'primary' ?>-subtle">
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <li class="activity-item text-center py-5">
